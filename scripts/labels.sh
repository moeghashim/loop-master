...
LABELS=(
  ...
  "difficulty:s|c2e0c6|Difficulty: small effort/risk (set by interview)"
  "difficulty:m|fef2c0|Difficulty: medium effort/risk (set by interview)"
  "difficulty:l|d93f0b|Difficulty: large effort/risk (set by interview)"
